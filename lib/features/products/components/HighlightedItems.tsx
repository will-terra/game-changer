...
export function HighlightedItems(props: Props) {
    ...
    return (
        <section className="flex h-[56.25rem] flex-col items-center justify-center gap-8 bg-black/50">
            <h2 className="text-[40px] font-bold uppercase">
                Items em
                <span className="bg-secondary-blue px-4 text-[40px] font-bold text-white uppercase">
                    destaque
                </span>
            </h2>
            <div className="grid grid-cols-3 place-items-center">
                ...
                <div className="flex h-[30rem] w-[27rem] flex-col items-center justify-between gap-4">
                    <HighlightedItemCard size="small"
